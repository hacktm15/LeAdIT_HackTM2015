...
// ReceiptsReader xMyC+Mqa3qBJ3p2zwGOQ/PbG    // Leo
// ReceiptsReaderAdina1 "Fad+SIjfUqS48hvYcIUi1Q3H" // Adina


public class AsyncProcessTask extends AsyncTask<String, String, Boolean> {

	private final String PASS = "Fad+SIjfUqS48hvYcIUi1Q3H";
	private final String ID = "ReceiptsReaderAdina1";
	...
	protected void onPreExecute() {
		dialog.setMessage("Se procesează");
...
//			!!! Please provide application id and password and remove this line. !!!
			...
			publishProgress( "Încărcare imagine...");

			String language = "English,Romanian"; // Comma-separated list: Japanese,English or German,French,Spanish etc.
			...
			*/
			...
			while( task.isTaskActive() ) {
				...
				Thread.sleep(5000);
				publishProgress( "Așteptați.." );
				task = restClient.getTaskStatus(task.Id);
			}
			
			if( task.Status == Task.TaskStatus.Completed ) {
				publishProgress( "Se descarcă.." );
